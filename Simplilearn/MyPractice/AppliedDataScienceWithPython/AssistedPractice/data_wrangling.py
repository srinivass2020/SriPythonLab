...
def main():
    print("Loading Data: housing_data_datawrangle")
    ...
    print("Missing values handled for columns:\n", missing_info)

    df = transform_variables(df)
    print("Data Shape after variable transformation:", df.shape)

    df = bin_year_built(df)
    print("YearBuilt binned into decades.")
